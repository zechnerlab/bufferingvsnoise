...
semilogy(phiTotGrid(markExampleIdx), NoiseReduction(markExampleIdx), 'o', 'Color', cols(2, :), 'MarkerFaceColor', cols(2, :));
semilogy(phiTotGrid(markExampleIdx),dLogPhi(markExampleIdx)./dLogPhiPlus(markExampleIdx), 'o', 'Color', cols(1, :), 'MarkerFaceColor', cols(1, :));
